...
/*
void Cratnost(int num, int a, int b)       //метод для проверки на ратнось, без возвращения -void
{
...
int DeleteDec()                                         //метод
{
    int randomNum = new Random().Next(100, 1000);         //введение рандомного трехзначного  числа
